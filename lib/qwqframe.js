 ...
 *     event?: {[x in (keyof HTMLElementEventMap)]?: (function(Event) : void)} // 事件绑定
...
class NList
{
    ...
    apply(element)
    {
        ...
        this.list.forEach(o =>
        {
            ...
            else if (o instanceof NTagName)
            {
                ...
                o.apply(element);
            else if (o instanceof NElement)
                element.addChild(o);
            else if (o instanceof NList)
            {
                if (o.flatFlag)
                    o.apply(element);
                else
    ...
    getElement()
    {
        ...
        if (tagName == "")
            tagName = "div";
        var ele = getNElement(document.createElement(tagName));
        this.apply(ele);
        return ele;
    }
...
export { NAsse, NAttr, NElement, NEvent, NList, NStyle, NTagName, cssG, divideLayout_DU, divideLayout_LR, divideLayout_RL, divideLayout_UD, expandElement, getNElement, mouseBind, runOnce, tag, tagName, touchBind };
